  ...
  return (
    <div className='w-full max-h-full bg-gray-100 grid place-items-center'>
      <div className="w-[90%] h-[90%] rounded-xl bg-white shadow-2xl p-6">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Fitness Tracker</h1>
        <p className="text-gray-600 mb-6 text-sm">Track your health and progress</p>
        ...
        <div className="m-2 h-[80%] w-full grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-2 pl-4 flex flex-col gap-5">
              ...
              <div className='flex justify-start gap-4 items-center flex-wrap'>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      • Oatmeal with fruits<br />
                      • Boiled eggs or paneer slices<br />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-700">Morning Snack</h3>
                    <p className="text-sm text-gray-600">
                      • 1 seasonal fruit<br />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      • Brown rice or multigrain rotis<br />
                      • Protein source (dal/paneer/chicken)<br />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-700">Evening Snack</h3>
                    <p className="text-sm text-gray-600">
                      • Roasted makhana or sprouts chaat<br />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      • Multigrain rotis or khichdi<br />
                      • Veg curry or soup<br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full">
            ...
            <div className="bg-rose-50 p-4 rounded-xl shadow-md flex items-start gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-red-800">Blood Pressure</h2>
            ...
            <div className="bg-purple-50 p-4 rounded-xl shadow-md flex items-start gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-purple-800">Glucose</h2>
            ...
            <div className="bg-orange-50 p-4 rounded-xl shadow-md flex items-start gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-orange-800">Blood Group</h2>
