...
function Diagnose() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-4 pt-[7%]">
      {/* Progress Bar */}
      <div className="relative mb-8 w-full max-w-2xl">
        <div
          ...
          style={{
            width: step === 0 ? "0%" : `${(step / (steps.length - 1)) * 60}%`,
          }}
        />
        <div className="flex justify-between items-center w-full bg-white px-8 py-4 rounded-xl shadow-xl relative">
          {steps.map((label, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`h-5 px-2 flex items-center justify-center rounded-2xl text-[10px] border ${bg}`}
                >
                  {label}
                </div>
              </button>
