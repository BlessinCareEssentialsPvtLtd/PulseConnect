...
const RightSideProfile = () => {
  return (
    <motion.div
      className=" w-[25%] h-[95vh] rounded-lg shadow-lg p-4 bg-white fixed top-8 right-2.5 transition-all duration-300 z-[5] min-w-[240px] overflow-y-scroll overflow-x-hidden"
